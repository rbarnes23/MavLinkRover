#ifndef _ROS_i2cpwm_board_ServoConfigArray_h
#define _ROS_i2cpwm_board_ServoConfigArray_h
...
namespace i2cpwm_board
{
  ...
  class ServoConfigArray : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "i2cpwm_board/ServoConfigArray"; };
